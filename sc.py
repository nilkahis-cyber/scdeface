...
print "Subscribe Channel Nilkahis cyber"
print "subscribe itu gratis bos ku ^__^"
print "================================"

title = raw_input("Masukkan judul: ")
nick = raw_input("Hacked by : ")
team = raw_input("Nama team kamu : ")
img = raw_input("Link gambar (png/gif) : ")
print "----------------------------------------------"
print "ini pesan halaman awal bos"
print "----------------------------------------------"
pesan = raw_input("Pesan pertama : ")
pesan2 = raw_input("Pesan kedua : ")
pesan3 = raw_input("Pesan ketiga : ")
pesan4 = raw_input("Pesan terakhir : ")
print "----------------------------------------------"
print "Kalo ini pesan buat si admin"
print "----------------------------------------------"
kata = raw_input("Kata pertama : ")
kata2 = raw_input("Kata kedua : ")
kata3 = raw_input("Kata terakhir : ")
greetz = raw_input("Thanks to : ")
print "Nama file (contoh:nilkahis.html)"
